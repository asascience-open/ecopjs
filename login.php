...
<html>
  <head>
    ...
    <style>
            body{margin: 0 0;padding: 0 0;font-family: Arial, Sans-Serif;font-weight: bold;background-color: #b5c0ca;background-image: url("config/<?php echo $config?>/img/bg.png");background-repeat: no-repeat;background-position: top left;}
...
case "login":
    ...
    {
        if(confirmuser($username,$password,$getUserInfo)) // As pointed out by asgard2005
        {
